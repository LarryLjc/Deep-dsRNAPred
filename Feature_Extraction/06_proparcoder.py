...
OUTPUT_SAVE_PATH = "Ensemble_Test_Performance_11_ML_ProteinPhysicochemical.xlsx"
...
if __name__ == "__main__":
    if os.path.exists(TRAIN_EXCEL_PATH) and os.path.exists(TEST_EXCEL_PATH):
        ...
        # ---------------------------------------------------------
        # 全局预先提取理化特征 (此类特征提取不依赖数据分布拟合，无泄露风险，
        # 因此在 Fold 外部全局提取一次即可，极大节省时间)
        # ---------------------------------------------------------
        print("Extracting Protein Physicochemical Properties...")
