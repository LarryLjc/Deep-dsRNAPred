...
# =============================================================================
# 4. Core Model Architecture: Deep_dsRNAPred (No CBAM)
# =============================================================================
...
def kfold_train(fold, train_features, train_labels, val_features, val_labels, 
    ...
    model = Deep_dsRNAPred(
        ...
        dropout_rate=0.2, num_classes=config.num_classes, lstm_hidden_size=LSTM_HIDDEN_SIZE, lstm_layers=LSTM_LAYERS
    ).to(config.device)
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print(f"5-Fold CV Summary (Model: Deep_dsRNAPred (No CBAM) | Feature: RNA-Ernie + Local PCA)")
    print(f"Parameters: SeqLen={MAX_SEQ_LENGTH}, LSTM_Dim={LSTM_HIDDEN_SIZE}")
    ...
    result_save_path = "Model_Performance_Deep_dsRNAPred_NoCBAM.xlsx"
