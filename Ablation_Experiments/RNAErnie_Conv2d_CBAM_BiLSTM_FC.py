...
LSTM_LAYERS = 2
CBAM_LAYERS = 2  # As per your latest config
...
class CNNBlock(nn.Module):
    """
    Standard CNN Block: 1x1 Conv(Projection) -> Standard Conv(k*1) -> BN -> ReLU -> AvgPool
    (Replaces SKAttention)
    """
    def __init__(self, in_planes, out_planes, kernel_size=3, pool_size=2):
        super(CNNBlock, self).__init__()
        
        # 1. 1x1 Conv: Projection
