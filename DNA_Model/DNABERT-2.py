...
def kfold_train(fold, train_features, train_labels, val_features, val_labels, 
    ...
    for epoch in range(epochs):
        ...
        # 打印信息中包含 Val MCC 和 Val AUC，不包含 Loss
    ...
    print(f"Fold {fold + 1} Best Result | "
          ...
          f"Test ACC: {test_metrics['ACC']:.1%} | Test F1: {test_metrics['F1']:.3f} | "
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print(f"5-Fold CV Summary (Model: Deep_dsRNAPred, Feature: DNABERT-2+StrictPCA(50))")
